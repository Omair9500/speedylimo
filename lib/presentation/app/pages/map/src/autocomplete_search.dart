  ...
  _performAutoCompleteSearch(String searchTerm) async {
    ...
    if (searchTerm.isNotEmpty) {
      final PlacesAutocompleteResponse response =
        ...
        location: Location(
            lat: provider.currentPosition?.latitude ?? 0,
            lng: provider.currentPosition?.longitude ?? 0),
        offset: widget.autocompleteOffset ?? 0,
        radius: widget.autocompleteRadius ?? 0,
